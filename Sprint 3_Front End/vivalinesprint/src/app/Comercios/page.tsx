    ...
    <main className="flex-1 flex justify-between px-8 items-center gap-[10vw] ">
      <div className="w-[45%] text-center flex flex-col gap-16 mb-40">
        <div className="flex items-center self-center gap-8">
          <Image className="md:pt-4 lg:w-[50px] " src="/assets/ViaMobilidade.svg" alt="ViaMobilidade-fundo" width={50} height={50}/>
          <h1 className="font-medium md:pt-4 md:text-[1.5rem] lg:text-[3rem]">
            Estação Paulista
          </h1>
        </div>
        

          <h2 className="font-normal md:text-[1.5rem] lg:text-[2.5rem]">
            Loja 1: Chilli Beans
          </h2>
