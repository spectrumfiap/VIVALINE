...
const Status = () => {
  return (
    <main className="flex-1 ">
        <div>
          <h1 className="font-sans pl-8 text-2xl sm:text-1xl md:text-3xl lg:text-[3rem] ">Status das linhas</h1>
        </div>

        <div className="flex items-center justify-center">
          <Image className=" w-[16rem] pt-6 sm:w-2 md:w-90 md:pt-5 lg:w-[450] " src="/assets/status-fundo.png" width={450} height={300} alt="Imagem-status"/>
        </div>
